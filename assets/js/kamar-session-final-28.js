(function(){
  ...
  function guard(){
    bridge();
    var f=file();
    var adminPages=['admin.html','admin-members.html','admin-internal.html','admin-activation.html','admin-activation-v2.html','admin-affiliate.html','admin-affiliate-v2.html','admin-affiliate-list.html','admin-affiliate-overview.html','admin-affiliate-reward.html','admin-affiliate-payment.html','admin-affiliate-commission-rate.html','admin-connection-check.html','admin-banner.html','admin-video.html','admin-materials.html','admin-payment.html','admin-settings.html','admin-tools.html','admin-maintenance.html','admin-page-control.html','admin-dashboard-control.html','admin-study-control.html','admin-links.html','admin-data-check.html'];
